...
public class SearchKeywordPageRequest extends PageRequest {
    ...
    @Schema(description = "검색 기간 시작일", example = "2024-01-01")
    private String startDate;
    
    @Schema(description = "검색 기간 종료일", example = "2024-12-31")
    private String endDate;
    
    @Schema(description = "정렬 기준 (searchCount,desc | keyword,asc)", example = "searchCount,desc")
    private String sort;
}
