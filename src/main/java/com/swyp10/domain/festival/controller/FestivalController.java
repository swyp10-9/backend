...
public class FestivalController {
    ...
    @GetMapping("/map")
    public FestivalListResponse getFestivalsForMap(@ModelAttribute FestivalMapRequest request) {
        return festivalService.getFestivalsForMap(request);
    }

    @Operation(summary = "축제 리스트 조회 - 달력 페이지", description = "축제 리스트 조회 - 달력 페이지")
    @GetMapping("/calendar")
    public FestivalListResponse getFestivalsForCalendar(@ModelAttribute FestivalCalendarRequest request) {
