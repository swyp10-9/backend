...
public class FestivalResponse {
    ...
    @Schema(description = "축제명", required = true, nullable = false, example = "여의도 벚꽃축제")
    private String name;
    ...
    @Schema(description = "생성일시", required = true, nullable = false, example = "2025-01-15T10:30:00")
    private LocalDateTime createdAt;

    @Schema(description = "수정일시", required = true, nullable = false, example = "2025-01-20T14:20:00")
